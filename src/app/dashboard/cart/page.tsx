...
export default async function CartPage() {
  ...
  return (
    <div>
      <h1 className="text-5xl flex flex-col items-center justify-center">Productos agregados al carrito</h1>

      <div className="flex flex-col sm:flex-row gap-2 w-full">
        <div className="flex flex-col gap-2 w-full sm:w-8/12 p-2">
        {
